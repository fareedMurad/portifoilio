...
import Preview1 from '../../assets/portfolio/collage (2).png';
import Preview2 from '../../assets/portfolio/collage (3).png';
import Preview3 from '../../assets/portfolio/collage (5).png';
import Preview4 from '../../assets/portfolio/collage (7).png';
import Preview5 from '../../assets/portfolio/collage (10).png';
import Preview6 from '../../assets/portfolio/collage (13).png';
import Preview7 from '../../assets/portfolio/collage (15).png';
import Preview8 from '../../assets/portfolio/collage (16).png';
import Preview9 from '../../assets/portfolio/collage (17).jpg';
//Components
            ...
            <Col xs={12} sm={12} md={8} lg={9}>
              <div className="portfolio__nav">
                <ul>
                  ...
                  <li
                    className={
                      this.state.pickedFilter === 'mob'
                        ? 'portfolio__nav-active font12'
                        : 'font12'
                    }
                    onClick={() => this.filterGallery('mob')}
                  >
                    MOBILE APPS
                  </li>
